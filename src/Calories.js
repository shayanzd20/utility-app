...
type Props = {};
export default class Calories extends Component<Props> {
      ...
      <View style={styles.container}>
        <View style={styles.rows}>
          ...
          <View style={[styles.currencyMotherBlockStyle,{backgroundColor:'transparent'}]}>
            <View style={{
                backgroundColor: 'rgba(77, 76, 186,0.7)',
                marginVertical: 7,
                marginLeft: 15,
                marginRight: 15,
                height:50,
              ...
              <View style={{ flex:1 ,flexDirection: 'row'}}>
                <View style={{ flex: 1, backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center'}}>
                  <Text style={[styles.buttonTextItem,{color:'white'}]}  >اندازه کالری</Text>
                </View>
                <View style={{ flex: 1, backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center'}}>
                  ...
                  renderItem={({ item }) =>
                        <View style={styles.currencyMotherBlockStyle}>
                          <View style={styles.currencyChildBlockStyle}>
                            <View style={{ flex:1 ,flexDirection: 'row'}}>
                              <View style={{ flex: 1, backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center'}}>
                                <Text style={styles.buttonTextItem}  >{item["اندازه کالری"]}</Text>
                              </View>
                              <View style={{ flex: 1, backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center'}}>
                                <Text style={styles.buttonTextItem}  >{item["مقدار"]}</Text>
                              </View>
                              <View style={{ flex: 1, backgroundColor: 'transparent', justifyContent: 'center', alignItems: 'center'}}>
                                <Text style={styles.buttonTextItem}  >{item["نام ماده غذایی"]}</Text>
                              </View>
                            </View>
                          </View>
                        </View>
...
const styles = StyleSheet.create({
  ...
  currencyChildBlockStyle: {
    backgroundColor: 'rgba(143, 142, 204,0.7)',
    marginVertical: 7,
    marginLeft: 15,
    marginRight: 15,
    paddingVertical: 5,
